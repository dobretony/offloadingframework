\chapter{GATT Service of the BLEOffloadingFramework}
\label{appendix:gattservice}

% All this appendix uses make syntax
\lstset{language=c, caption=GATT Service Implementation, label=lst:gattservice}
\begin{lstlisting}
...
static int adapter_cmp(gconstpointer a, gconstpointer b)
{
        ...
        if (gatt_adapter->adapter == adapter) return 0;
        return -1;
}
